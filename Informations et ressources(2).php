...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Geologica:wght@200&family=Klee+One:wght@600&family=Poppins:wght@200&family=Raleway:wght@300&family=Viga&display=swap" rel="stylesheet">
</head>
<body>
    <script src="Informations et ressources(2).js"></script>
    <nav class="top">
    ...
    <header>
        ...
        <main>
            ...
            <div class=Infos-et-ressources>
                ...
                <p>Vous avez indiqué présenter des troubles autistiques. Voici une liste de sports avec des programmes adaptés pour vous: </p><br>
                <h4>Natation</h4>
                <p>Environnement sensoriel apaisant,  prévisibilité et effet régulateur, la natation peut aussi aider à développer la coordination, la force musculaire et la confiance en soi.</p><br>
                <h4>Athlétisme</h4>
                <h4>Equitation</h4>
                <h4>Arts martiaux</h4>
                <h4>Gymnastique</h4>
