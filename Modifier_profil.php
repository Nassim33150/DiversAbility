...
<body>
    <script src="Modifier-profil.js"></script>
    <nav class="top">
        ...
        <main>
            <div class="modifier-profil">
                ...
                <form action="#" class="Inscription">
                    ...
                    <input type="adresse" name="adresse" id="adresse" > <br>
                    <label for="ville">Votre ville :</label> <br>
                    <input type="ville" id="ville" name="ville"> <br>
                    <label for="cp">Votre code postal :</label> <br>
                    <input type="cp" name="cp" id="cp"> <br>
                    <label for="message">Votre type de neurodivergence :</label> <br>
                    <textarea name="neuro" id="message" cols="30" rows="5" ></textarea> <br>
                    <label for="sport">Votre activité sportive préférée :</label> <br>
